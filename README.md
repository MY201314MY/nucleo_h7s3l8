...
-- Zephyr version: 4.3.99 (/home/pi/zephyr/zephyr), build: v4.3.0-3078-g23892b038f6a
[488/488] Linking C executable zephyr/zephyr.elf
Memory region         Used Size  Region Size  %age Used
           FLASH:      407064 B         8 MB      4.85%
             RAM:      253464 B       456 KB     54.28%
...
Generating files from /home/pi/example/zephyr/STMicroelectronics/nucleo_h7s3l8/pka/build/pka/zephyr/zephyr.elf for board: nucleo_h7s3l8
image.py: sign the payload
image.py: sign the payload
[11/16] Performing build step for 'mcuboot'
[1/290] Preparing syscall dependency handling

[3/290] Generating include/generated/zephyr/version.h
-- Zephyr version: 4.3.99 (/home/pi/zephyr/zephyr), build: v4.3.0-3078-g23892b038f6a
[290/290] Linking C executable zephyr/zephyr.elf
Memory region         Used Size  Region Size  %age Used
           FLASH:       43352 B        64 KB     66.15%
          ...
          EXTMEM:          0 GB        32 MB      0.00%
        IDT_LIST:          0 GB        32 KB      0.00%
Generating files from /home/pi/example/zephyr/STMicroelectronics/nucleo_h7s3l8/pka/build/mcuboot/zephyr/zephyr.elf for board: nucleo_h7s3l8
...
```shell
commit aafb107710dc96d001528f223aef9504de31b307 (HEAD -> nucleo_h7s3l8_tls)
Author: mteaching <3477669308@qq.com>
Date:   Sat May 30 18:46:17 2026 +0800

    optimize for board nucleo_h7s3l8.
    
    flash size : 8M
    HAL dirver : PKA/RTC/PWR/HASH/CRYP.
    optimize mbedTLS debug.
    mbedTLS hardware accelerate.
    RAM region.
```
...
```shell
pi@inspiron:~/zephyr/modules/crypto/mbedtls$ git log -n 1
commit de9c73759e5634773455cdc6d8f203feee41445c (HEAD -> dev-1.0.0)
Author: mteaching <3477669308@qq.com>
Date:   Sun May 17 19:20:07 2026 +0800
