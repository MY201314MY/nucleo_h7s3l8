...
diff --git zephyr/drivers/ethernet/Kconfig.stm32_hal zephyr/drivers/ethernet/Kconfig.stm32_hal
index 00100dc5f0b..7084e8c80b1 100644
--- zephyr/drivers/ethernet/Kconfig.stm32_hal
+++ zephyr/drivers/ethernet/Kconfig.stm32_hal
@@ -9,6 +9,9 @@ menuconfig ETH_STM32_HAL
 	default y
 	depends on DT_HAS_ST_STM32_ETHERNET_ENABLED
 	select USE_STM32_HAL_ETH
+	select USE_STM32_HAL_PKA
+	select USE_STM32_HAL_RNG
+	select USE_STM32_LL_PKA
...
=== diff for hal_stm32 (modules/hal/stm32):
diff --git modules/hal/stm32/stm32cube/stm32h7rsxx/drivers/src/stm32h7rsxx_hal_pka.c modules/hal/stm32/stm32cube/stm32h7rsxx/drivers/src/stm32h7rsxx_hal_pka.c
index d62eb2225..800008d95 100644
--- modules/hal/stm32/stm32cube/stm32h7rsxx/drivers/src/stm32h7rsxx_hal_pka.c
+++ modules/hal/stm32/stm32cube/stm32h7rsxx/drivers/src/stm32h7rsxx_hal_pka.c
@@ -399,7 +399,7 @@ HAL_StatusTypeDef HAL_PKA_Init(PKA_HandleTypeDef *hpka)
...
+    printf("F:%s -- L:%d\r\n", __func__, __LINE__);
     ...
     {
@@ -408,6 +408,7 @@ HAL_StatusTypeDef HAL_PKA_Init(PKA_HandleTypeDef *hpka)
       /* Check the Timeout */
...
+        printf("F:%s -- L:%d\r\n", __func__, __LINE__);
         ...
         err = HAL_TIMEOUT;
         break;
@@ -416,19 +417,23 @@ HAL_StatusTypeDef HAL_PKA_Init(PKA_HandleTypeDef *hpka)
 
     /* Get current tick */
     tickstart = HAL_GetTick();
+    printf("F:%s -- L:%d\r\n", __func__, __LINE__);
 
+    printf("F:%s -- L:%d -- CR:0x%08X\r\n", __func__, __LINE__, hpka->Instance->CR);
+    printf("F:%s -- L:%d -- SR:0x%08X\r\n", __func__, __LINE__, hpka->Instance->SR);
...
@@ -436,7 +441,7 @@ HAL_StatusTypeDef HAL_PKA_Init(PKA_HandleTypeDef *hpka)
   {
     err = HAL_ERROR;
   }
-
...
diff --git modules/hal/stm32/stm32cube/stm32h7rsxx/drivers/src/stm32h7rsxx_hal_rng.c modules/hal/stm32/stm32cube/stm32h7rsxx/drivers/src/stm32h7rsxx_hal_rng.c
index b114b250f..159ba8211 100644
--- modules/hal/stm32/stm32cube/stm32h7rsxx/drivers/src/stm32h7rsxx_hal_rng.c
+++ modules/hal/stm32/stm32cube/stm32h7rsxx/drivers/src/stm32h7rsxx_hal_rng.c
@@ -153,6 +153,7 @@
   */
...
+  printf("F:%s -- L:%d\r\n", __func__, __LINE__);
   ...
   if (hrng == NULL)
@@ -162,7 +163,7 @@ HAL_StatusTypeDef HAL_RNG_Init(RNG_HandleTypeDef *hrng)
...
+  printf("F:%s -- L:%d\r\n", __func__, __LINE__);
   ...
   {
@@ -181,6 +182,7 @@ HAL_StatusTypeDef HAL_RNG_Init(RNG_HandleTypeDef *hrng)
...
@@ -205,7 +207,7 @@ HAL_StatusTypeDef HAL_RNG_Init(RNG_HandleTypeDef *hrng)
...
+  printf("F:%s -- L:%d\r\n", __func__, __LINE__);
   ...
   {
@@ -220,7 +222,7 @@ HAL_StatusTypeDef HAL_RNG_Init(RNG_HandleTypeDef *hrng)
       }
     }
   }
-
...
@@ -233,26 +235,14 @@ HAL_StatusTypeDef HAL_RNG_Init(RNG_HandleTypeDef *hrng)
   /* Get tick */
   tickstart = HAL_GetTick();
